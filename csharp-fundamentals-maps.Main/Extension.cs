...
namespace csharp_fundamentals_maps.Main
{
    public class Extension
    {
        ...
        //       closest to the sun and furthest from the sun.  Update the methods to return the correct KeyValuePair's Key (the string)!
        //       Note you need either the First or Last item in the Dictionary depending on 
